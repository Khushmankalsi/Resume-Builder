        ...
        <div class="bg-white rounded shadow p-2 mt-4" style="min-height:80vh">
            ...
            <div>
                ...
                <div class="col-md-6">
                        ...
                        <input type="text" name="resume_title" placeholder="Web Developer Resume" value="Resume<?=time()?>" class="form-control" required >
                    </div>
                    <h5 class="mt-3 text-secondary"><i class="bi bi-person-badge"></i> Personal Information</h5>
                    
                    <div class="col-md-6">
                        <label class="form-label">Full Name</label>
                        <input type="text" name="full_name" placeholder="User_Name" class="form-control" required >
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" name="email_id" placeholder="demo@gmail.com" class="form-control" required >
                    </div>
                    <div class="col-12">
                        <label for="inputAddress" class="form-label"> Objective</label>
                        <textarea class="form-control" name="objective" placeholder="What' your objective?" id=""></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Mobile No</label>
                        <input type="number" min="1111111111" name="phone_no" placeholder="9569569569" max="9999999999"
