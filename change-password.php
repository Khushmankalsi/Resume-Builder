            ...
            <form action="actions/changepassword.action.php" method="post" >
                <div class="d-flex gap-2 justify-content-center">
                    ...
                    <div>
                        ...
                        <p class="m-0">Change Passwordsdfsd With around 24 words </p>
                ...
                <div class="form-floating mb-4">
                    <input type="number" class="form-control" id="floatingEmail" name="password" placeholder="name@example.com" required>
